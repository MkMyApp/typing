...
　if (accuracy < 50) return "F"; 
  if (cpm >= 100 && accuracy >= 100) return "神";
  if (cpm >= 70 && accuracy >= 99) return "超人";
  if (cpm >= 50 && accuracy >= 98) return "名人";
  if (cpm >= 40 && accuracy >= 95) return "S+";
  if (cpm >= 35 && accuracy >= 90) return "S";
  if (cpm >= 30 && accuracy >= 85) return "A";
  if (cpm >= 25 && accuracy >= 80)  return "B";
  if (cpm >= 20 && accuracy >= 70)  return "C";
  if (cpm >= 15 && accuracy >= 60)  return "D";
