...
function getRank(cpm, accuracy) {
  ...
  if (cpm >= 450 && accuracy >= 99) return "大陰陽師";
  if (cpm >= 400 && accuracy >= 98) return "天文博士";
  if (cpm >= 300 && accuracy >= 95) return "陰陽頭";
  if (cpm >= 200 && accuracy >= 90) return "陰陽師";
  if (cpm >= 100 && accuracy >= 85) return "陰陽生";
  if (cpm >= 90 && accuracy >= 75)  return "呪禁生";
  if (cpm >= 80 && accuracy >= 70)  return "見習い";
  if (cpm >= 70 && accuracy >= 65)  return "式神使いの卵";
  if (cpm >= 60 && accuracy >= 60)  return "式神";
  return "迷い人";
}
